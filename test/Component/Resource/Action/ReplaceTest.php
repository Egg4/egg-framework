...
use \Egg\Container;
use \Egg\Component\Resource\Action\Replace as ReplaceComponent;
...
class ReplaceTest extends \Egg\Test
{
    public function testShouldReturn200()
    {
        ...
        $controller = new ClosureController(function($action, $arguments) use($body, $result) {
            $this->assertEquals($action, 'replace');
        ...
        $component = new ReplaceComponent();
